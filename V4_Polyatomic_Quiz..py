...
# new
from st_paywall import add_auth # Optional: for login
...
with st.expander("📤 Submit your score to the teacher"):
    student_name = st.text_input("Enter your full name:")
    if st.button("Submit to Gradebook"):
        if student_name:

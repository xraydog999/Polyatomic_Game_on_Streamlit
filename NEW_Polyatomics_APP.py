# modified by Gemini to address use of python's input function
...
# This keeps track of the score and current question across web refreshes
...
if not st.session_state.quiz_over:
    ...
    # Form used so the page doesn't refresh on every character typed
